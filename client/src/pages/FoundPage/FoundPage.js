        ...
        <Row>
            ...
            <Col size="4">
                <div className="card wholecard" style={{width: '18rem', height: '30rem'}}>
                    <img className="card-img-top" style={{width: '18rem', height: '30rem', borderRadius: '5'}} src={"https://lh5.googleusercontent.com/p/AF1QipOrwWBES9B0t2hzBN8HOg8jITdWKVN8G8qweDpm=w203-h135-k-no"} alt="Restaurant" />
